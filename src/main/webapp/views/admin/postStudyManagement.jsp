			...
			<div class="right">
		                        	...
		                        	<script>
								        function deleteContent(num){
								            if(confirm("정말 삭제 하시겠습니끼?")){
								            	location.href='<%= contextPath %>/deletePost.ad?no=' + num + '&category=3';
								            }
								        }
			                    	</script>
		                        </td>
	            ...
	            <div class="paging-area">
	                ...
	                <% if(pageInfo.getCurrentPage() > 5){ %>
	                	<a href="<%= contextPath %>/postStudyListView.ad?cpage=1">1</a><span>&nbsp;···&nbsp;</span>
	                <% } %>
	                ...
	                <% if(pageInfo.getCurrentPage() != pageInfo.getMaxPage()){ %>
		                <% if(pageInfo.getMaxPage() > 5){ %>
			                <span>&nbsp;···&nbsp;</span><a href="<%= contextPath %>/postStudyListView.ad?cpage=<%= pageInfo.getMaxPage() %>"><%= pageInfo.getMaxPage() %></a>                
		                <% } %>
