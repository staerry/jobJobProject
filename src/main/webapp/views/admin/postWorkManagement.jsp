...
<%
	ArrayList<Community> list = (ArrayList<Community>)request.getAttribute("work");
	...
	<div class="left">
		...
		<div class="right">
			...
			<ul class="mentor-post-category">
				<li>
					<input type="radio" name="category" id="work" value="1" checked>
		    ...
		    <table class="table table-bordered table-hover admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-sm btn-danger" onclick="location.href='<%= contextPath %>/deletePost.ad?no=<%= i.getCommNo() %>&category=1'">삭제</button></td>
                    </tr>
            ...
            <div class="paging-area">
                ...
                <% for(int i = pageInfo.getStartPage(); i <= pageInfo.getEndPage(); i++){ %>
                	...
                	<% } else { %>
                		<a href="<%= contextPath %>/postWorkListView.ad?cpage=<%= i %>"><%= i %></a>
                	<% } %>
                <% } %>
