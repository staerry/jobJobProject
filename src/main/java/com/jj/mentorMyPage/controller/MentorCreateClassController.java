...
/**
 * Servlet implementation class MentorCreateClassController
 */
@WebServlet("/createClass.my")
public class MentorCreateClassController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MentorCreateClassController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/mentorMyPage/createClass.jsp").forward(request, response);
...
//					폴더 : classCreateImgFiles
			...
			String clInfo= multiRequest.getParameter("classInfo");
			String clCurri= multiRequest.getParameter("curri");
...
//				/classList.my
				...
				response.sendRedirect(request.getContextPath() + "/classList.my");
