...
/**
 * Servlet implementation class ReviewManagementPage
 */
@WebServlet("/reviewListView.ad")
public class ReviewManagementPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int listCount = new AdminService().selectReviewCount();
		...
		ArrayList<Review> list = new AdminService().selectReviewList(pageInfo);
